...
export const RegisterForm = () => {
  const { fields, errors, toast, handleChange, handleSubmit } =
    useRegisterForm();
  return (
    <div className="w-[85%] sm:w-full max-w-sm mx-auto px-5 sm:px-8 py-6 bg-white rounded-[35px] relative">
      ...
      <div className="pb-2 text-center">
        ...
        <h2 className="text-gray-500 font-thin text-[13px]">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div>
          ...
          <div className="text-center mt-2">
            ...
            <span className="text-[#6C63FF] font-medium text-sm cursor-pointer">
              Iniciar Sesión
            </span>
          </div>
        </div>

  ...
  return (
    <div className="flex flex-col bg-src-091328 border border-white/5 rounded-[16px] overflow-hidden">
      <div className="px-4 sm:px-8 py-6 sm:py-8 border-b border-white/5">
        <h2 className="text-src-e5e7f6 font-bold text-lg sm:text-xl">
          Redes Sociales
        </h2>
      </div>
        ...
        <div className="flex flex-col gap-4">
          {(
            ...
            <div key={key} className="flex items-start gap-2 sm:gap-4">
              <div className="w-10 h-10 rounded-[8px] bg-src-000000 border border-white/5 flex items-center justify-center text-src-a7aab9 shrink-0 mt-0.5">
                {icon}
              </div>
              <div className="flex flex-col flex-1 min-w-0">
                <input
                  ...
                  className={`
                    w-full min-w-0 bg-src-000000 border rounded-[12px] px-3 sm:px-4 py-3
